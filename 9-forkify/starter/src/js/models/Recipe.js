// Recipe.js: const res = await axios(`${PROXY}http://food2fork.com/api/get?key=${KEY}&rId=${this.id}`); -> replace with line below
        ...
        const newIngredients = this.ingredients.map(el => {
            ...
            if(unitIndex > -1) {
                ...
                objIng = {
                    count: 1,
                    unit: '',
                    ingredient: ingredient.trim() //same as ingredient: ingredient
                }
            }
